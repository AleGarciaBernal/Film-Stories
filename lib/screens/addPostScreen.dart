  ...
  _selectImage(BuildContext parentContext) async {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          title: const Text('SHARE A MOVIE WITH US'),
          children: <Widget>[  
            SimpleDialogOption(
                padding: const EdgeInsets.all(20),
                child: const Text('Choose a FRAME from Gallery'),
                onPressed: () async {
  ...
  void postImage(String uid, String username, String profImage) async {
    ...
    try {
      ...
      if (res == "success") {
        ...
        showSnackBar('...and ACTION!', context);
        clearImage();
      } else {
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                            hintText: "Movie: Titanic- Directed: James Cameron (2001) (Example)" ,
